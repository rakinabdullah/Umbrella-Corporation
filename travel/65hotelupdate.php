...
?> 
        <form  method="post" action ="">
          ...
          <?php 
$sql="SELECT distinct COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = N'hotels'";
...
?>
 ...
 include ("dbconnection.php");
        ...
        if(isset($_POST["submit3"])){
            ...
            $query= "UPDATE `hotels` SET `$_POST[b]` = '$_POST[n]' WHERE `hotels`.`$_POST[a]` = '$_POST[o]'";
