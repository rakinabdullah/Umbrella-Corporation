...
?> 
        <form  method="post" action ="">
          ...
          <?php 
$sql="SELECT distinct COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = N'tourist_places'";
...
?>
 ...
 include ("dbconnection.php");
        ...
        if(isset($_POST["submit3"])){
            ...
            $query= "UPDATE `tourist_places` SET `$_POST[b]` = '$_POST[n]' WHERE `tourist_places`.`$_POST[a]` = '$_POST[o]'";
