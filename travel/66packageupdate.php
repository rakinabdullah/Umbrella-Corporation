...
?> 
        <form  method="post" action ="">
          ...
          <?php 
$sql="SELECT distinct COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = N'packages'";
...
?>
 ...
 include ("dbconnection.php");
        ...
        if(isset($_POST["submit3"])){
            ...
            $query= "UPDATE `packages` SET `$_POST[b]` = '$_POST[n]' WHERE `packages`.`$_POST[a]` = '$_POST[o]'";
