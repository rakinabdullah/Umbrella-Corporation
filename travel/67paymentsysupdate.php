...
?> 
        <form  method="post" action ="">
          ...
          <?php 
$sql="SELECT distinct COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = N'payment_system'";
...
?>
 ...
 include ("dbconnection.php");
        ...
        if(isset($_POST["submit3"])){
            ...
            $query= "UPDATE `payment_system` SET `$_POST[b]` = '$_POST[n]' WHERE `payment_system`.`$_POST[a]` = '$_POST[o]'";
