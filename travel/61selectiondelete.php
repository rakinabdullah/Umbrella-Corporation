...
?> 
        <form  method="post" action ="">
          ...
          <?php 
$sql="SELECT distinct COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = N'user_selection'";
 ...
 <input type="submit" name="submit2" value="delete">  
      ...
      <?php  
        ...
        if(isset($_POST["submit2"])){
               ...
               $query= "DELETE FROM `user_selection` WHERE `user_selection`.`$_POST[a]` = '$_POST[d]' "; 
